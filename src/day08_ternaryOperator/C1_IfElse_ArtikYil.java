...
public class C1_IfElse_ArtikYil {
	...
	public static void main(String[] args) {
		...
		if (yil%4 !=0) {
			System.out.print("Girdiginiz yil artik yil degildir."); // 4 ile bolunemeyenler
		} else if (yil%100 !=0) { // 4 ile bolunebilenler
			System.out.print("Girdiginiz yil artik yildir."); // 4 ile bolunenlerden 100 ile bolunebilenler		
		} else if (yil%400 ==0) {
