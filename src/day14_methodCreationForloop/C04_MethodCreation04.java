...
public class C04_MethodCreation04 {
	...
	public static void main(String[] args) {
       ...
       // ismiDuzelt(musteriSoyismi); normalde ilk basta boyle yaptik ama 
       // kalici olmasi icin alt satirdaki gibi atama yapmamiz lazim
   ...
   }			// burda voin yerine String yazdirmaliyiz onun icin asagiya return yapiyoz
