...
public class C07_Runner {
	...
	public static void main(String[] args) {
		...
		// scan objesinin ozelliklerini System.in parametresi ile belirliyoruz.

		obj1.isim = "Mehmet Tekstil";
		obj1.tel = "3125478798";

		System.out.println(obj1.isim + " " + obj1.tel);
		// obj1 in istedigimiz ozelliklerine(variable) deger atayabiliriz
		// eger deger atamazsak, ilk atanan degeri getirir.
